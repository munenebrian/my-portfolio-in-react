    ...
    <div name="about" className="w-full h-screen bg-gradient-to-b from-gray-800 to-black text-white">
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        ...
        <p className="text-xl mt-20">
          Brian is a fullstack engineer aspiring to take part in the technological world in a big way.
          ...
          I'm pursuing a bachelor's degree in Mathematics and Computer Science.I am also a certified fullstack engineer after undergoing a Software Enginnering bootcamp at Moringa School.
        ...
        <p className="text-xl">
          ...
          Those preceeding me always encourage me especially with their work and what they are doing to make our world a better place through tech. This, this is what keeps me going, this is what i want to be.
        </p>
      </div>
    </div>
  );
